          ...
          <div className="row">
            <div className="event-card">
              ...
              <p className="event-description">
                ...
                difference. A donation drive, #Lit-drive, organized in
                association with The Goonj Foundation marks the beginning of
                Litopia.
              </p>
              <button className="event-btn">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://www.instagram.com/p/CoKlMy1MrUX/?igshid=MDJmNzVkMjY="
                >
                  Know More
                </a>
              </button>
            ...
            <div className="event-card">
              ...
              <p className="event-description">
                ...
                have us all mesmerized by just their word play! 
              </p>
              <button className="event-btn">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://forms.gle/eMc37w9bBVXJoV5LA"
                >
                  Register
                </a>
              </button>
            ...
            <div className="event-card">
              ...
              <p className="event-description">
                Since between the pages of a book is a lovely place to be, the
                book fair will include a variety of genres for every book lover.
                From fantasy to real-life stories, from mystery to adventure,
            ...
            <div className="event-card">
              ...
              <p className="event-description">
                ...
                secret treasure with the help of those valuable clues, with the
            ...
            <div className="event-card">
              ...
              <p className="event-description">
                ...
                Lit-Con gives you a chance to dress up as a fictional person and
                have a fun panel discussion with other panelist.
              </p>
              <button className="event-btn">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://forms.gle/KTtMjdWcwnS564tX7"
                >
                  Register
                </a>
              </button>
            ...
            <div className="event-card">
              ...
              <p className="event-description">
                ...
                and let the world know what you've got as the stage awaits your
                magic!
              </p>
              <button className="event-btn">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://forms.gle/8dx2x4qojH6KadzY7"
                >
                  Register
                </a>
              </button>
